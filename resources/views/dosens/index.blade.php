...
<body>
    ...
    <div class="content">
        ...
        <a href="{{ route('dosens.create') }}" class="btn btn-md btn-success btn-action">Tambah Dosen</a>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $dosen->alamat }}</td>
                    <td>
                        <a href="{{ route('dosens.show', $dosen->id) }}" class="btn btn-sm btn-dark">Detail</a>
                ...
                @empty
                <tr>
                    <td colspan="7" class="text-center">Data dosen belum tersedia.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
