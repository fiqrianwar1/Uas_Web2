    ...
    <div class="content">
        ...
        <form action="{{ route('makuls.update', $makul->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="id" name="id" value="{{ $makul->id }}" readonly>
            </div>
            <div class="form-group">
                <label for="kd_makul">Kode Makul</label>
                <input type="text" class="form-control" id="kd_makul" name="kd_makul" value="{{ $makul->kd_makul }}" required>
            </div>
            <div class="form-group">
                <label for="nama_makul">Nama Makul</label>
                <input type="text" class="form-control" id="nama_makul" name="nama_makul" value="{{ $makul->nama_makul }}" required>
            </div>
            <div class="form-group">
                <label for="sks">SKS</label>
                <input type="number" class="form-control" id="sks" name="sks" value="{{ $makul->sks }}" required>
            </div>
