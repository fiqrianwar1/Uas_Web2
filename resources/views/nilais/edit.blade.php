    ...
    <div class="content">
        ...
        <form action="{{ route('nilais.update', $nilai->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="id" name="id" value="{{ $nilai->id }}" readonly>
            </div>
            <div class="form-group">
                <label for="makul_id">Mata kuliah</label>
                <input type="hidden" name="makul_id" value="{{ $nilai->makul_id }}">
                <input type="text" class="form-control" value="{{ $nilai->makul->nama_makul }}" readonly>
            </div>
            <div class="form-group">
                <label for="mahasiswa_id">Nama Mahasiswa</label>
                <input type="hidden" name="mahasiswa_id" value="{{ $nilai->mahasiswa_id }}">
                <input type="text" class="form-control" value="{{ $nilai->mahasiswa->nama }}" readonly>
            </div>
            <div class="form-group">
